...
async def mock_course():
    ...
    "Learn how to use machine learning in business",
    language="English",
    ...
    for i in range(31,50):
        course_data = {
            ...
            "language": "English",
            "purpose": "The purpose of this Course is to teach all basic skills about "+ categories.get(str(i)),
            "chapter": {"Introduction to " + categories.get(str(i)): "https://youtu.be/aZj6VL_9mXg",
                        categories.get(str(i)) +"EP. 1 ":"https://www.youtube.com/watch?v=zC_0xOSX1dY&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W",
                        categories.get(str(i)) +"EP. 2 " : "https://www.youtube.com/watch?v=kC3Szw7b154&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=2",
                        categories.get(str(i)) +"EP. 3 " : "https://www.youtube.com/watch?v=EhQasD1B_6o&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=3",
                        categories.get(str(i)) +"EP. 4 " : "https://www.youtube.com/watch?v=DePYgzAhKeI&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=4",
                        categories.get(str(i)) +"EP. 5 " : "https://www.youtube.com/watch?v=nRrNES7DO14&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=5",
                        categories.get(str(i)) +"EP. 6 ":"https://www.youtube.com/watch?v=zC_0xOSX1dY&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W",
                        categories.get(str(i)) +"EP. 7 " : "https://www.youtube.com/watch?v=kC3Szw7b154&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=2",
                        categories.get(str(i)) +"EP. 8 " : "https://www.youtube.com/watch?v=EhQasD1B_6o&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=3",
                        categories.get(str(i)) +"EP. 9 " : "https://www.youtube.com/watch?v=DePYgzAhKeI&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=4",
                        categories.get(str(i)) +"EP.  " : "https://www.youtube.com/watch?v=nRrNES7DO14&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=5"
                    },
            "requirement": "don't have to learn anything before",
            "description": "This is the full description for " + categories.get(str(i)),
            "target": "The target audience for Course " + categories.get(str(i)) + "is",
