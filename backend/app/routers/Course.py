...
async def mock_course():
    ...
    # chapters = {"First step to " + categories.get(str(i)): "https://youtu.be/aZj6VL_9mXg",
    #                     categories.get(str(i)) +"EP. 1 " : "https://www.youtube.com/watch?v=5dU0tMIp5QM",
    #                     categories.get(str(i)) +"EP. 2 " : "https://www.youtube.com/watch?v=2_b9ejo5c-Q",
    ...
    #                     "Final EP. of " + categories.get(str(i)) : "https://www.youtube.com/watch?v=nRrNES7DO14&list=PLoTScYm9O0GEvHKqqib-AdVFwVe_2ln8W&index=5"
    #                 },
...
async def create_course(course_data: dict = Body(...)):
    try:
        new_course = Course(course_data.get("name"),course_data.get("short_description"),course_data.get("date"),course_data.get("language")
                            ,course_data.get("purpose"),course_data.get("chapters"),course_data.get("requirement"),course_data.get("description"),course_data.get("target")
